        ...
        <div className="flex min-h-[85vh] md:min-h-screen items-end pb-8 md:items-start md:pt-48 md:pb-24">
          ...
          >
            ...
            <motion.h1
              ...
              className="mt-7 font-[var(--font-heading)] text-[2.5rem] font-semibold leading-[0.98] tracking-[-0.02em] text-white drop-shadow-[0_10px_30px_rgba(0,0,0,0.60)] sm:text-5xl md:text-6xl lg:text-7xl"
