...
import { CONTACT } from "@/data/site-links";
                ...
                <div className="relative px-6 py-14 text-center md:px-16 md:py-20">
                    ...
                    <div className="mt-12 flex flex-wrap justify-center gap-8 border-t border-white/20 pt-8">
                        <div className="text-center">
                            ...
                            <div className="text-xs text-white/60">Kişilik Mekan Kapasitesi</div>
                        </div>
                        <div className="text-center">
                            <a
                                href={CONTACT.maps}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-2xl font-bold text-white underline-offset-4 hover:underline"
                            >
                                Google Maps
                            </a>
                            <div className="text-xs text-white/60">Eyüpsultan, Çırçır</div>
                        </div>
                        <div className="text-center">
                            <div className="text-2xl font-bold text-white">{CONTACT.phoneDisplay}</div>
                            <div className="text-xs text-white/60">Hızlı İletişim Hattı</div>
                        </div>
                    </div>
                </div>
